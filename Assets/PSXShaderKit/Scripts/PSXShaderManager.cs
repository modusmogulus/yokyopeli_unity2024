...
namespace PSXShaderKit
{
    ...
    public class PSXShaderManager : MonoBehaviour
    {
        ...
        public void UpdateValues()
        {
            ...
            Shader.SetGlobalFloat("_PSX_TextureWarpingFactor", 0f);
            
            


            //---------------------WAIT WHAT MIKS TÄÄ VITTU HAJOTTAA KOKO GAMEOBJEKTIN??????----------------------
            //-------------------- MENI VITTU 5 TUNTIA ETTÄ TAJUSIN SEN JOHTUVAN TÄSTÄ EI HELVETTI :sob: ---------------------------
            if (MainGameObject.Instance != null && MainGameObject.Instance.s_reduceNausea == true) //OMAA KOODIA
            {
                Shader.SetGlobalFloat("_PSX_GridSize", 100f);
                Shader.SetGlobalFloat("_PSX_TextureWarpingFactor", 0f);
            }
